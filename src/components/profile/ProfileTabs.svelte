...
<div use:melt={$root} class="flex gap-7 grow flex-col md:flex-row items-start">
  <div class="flex flex-col gap-5 grow w-full md:max-w-80">
  ...
  <div class="grow w-full md:w-auto">
    <div
      ...
      class="bg-base-300 rounded-xl mx-auto flex-col p-5 max-w-[70rem] w-full {$value ===
      'tab-1'
        ? 'flex'
        : ''}"
    >
